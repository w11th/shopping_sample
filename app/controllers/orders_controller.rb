class OrdersController < ApplicationController
  ...
  def create
    shopping_carts = ShoppingCart.find_by_user_uuid(current_user.uuid).includes(:product)
    ...
    redirect_to generate_pay_payments_path(order_nos: orders.pluck(:order_no))
  end
end
